...
public class Constraints {
	...
	public static String setSqlDateFormat(LocalDate localDateFinal) {

		SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
		String dataFormatada = formato.format(localDateFinal);

		return dataFormatada;

	}

	// Passar Date para string formatada

	public static String setDateFormat(java.util.Date date) {

		DateFormat formatBR = new SimpleDateFormat("dd/MM/YYYY");
		String dataBr = formatBR.format(date);
